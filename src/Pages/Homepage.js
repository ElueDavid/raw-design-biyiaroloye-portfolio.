...
import mission from "../assets/images/My mission.png"
import mobileMission from "../assets/images/Mission-mpbile-img.png"
      ...
      (entries, observer) => {
        entries.forEach(entry => {
          ...
          if (entry.isIntersecting) {
            ...
            intervalId = setInterval(changeBrandNumber, 100);
          }
          else{
    ...
    <div className='homepage'>
      ...
      <div ref={meetBiyiRef} className='homepg-biyi'>
        ...
        <div className='homepg-biyi-text'>
          <img src={Namelogo} alt='name logo' className='biyi-name-img' />
      ...
      <div className='homepg-brand' ref={brandRef}>
          ...
          <div ref={brandDivRef} onClick={portfolioClick} className='homepg-brand-portfolio'>
            View Portfolio
          </div>
      </div>
      <BackToTopButton/>
