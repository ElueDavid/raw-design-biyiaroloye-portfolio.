...
import biyipageNav from "../Styles/navbiyipage.module.css"

export default function Biyipagenav({page}) {
  ...
  return (
    ...
    <nav className={isWindowScrolled ?'desktop-nav disappear': 'desktop-nav navbar'} ref={navRef}>
        ...
        <div className={biyipageNav.biyipagelink} onClick={()=> navigate('/biyi')}>
