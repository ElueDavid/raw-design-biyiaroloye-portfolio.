...
import portfolioNav from "../Styles/navportfolio.module.css"

export default function PortfolioNav({page}) {
  ...
  return (
    ...
    <nav className={isWindowScrolled ?'desktop-nav disappear': 'desktop-nav navbar'} ref={navRef}>
        ...
        <div className={portfolioNav.portfolioLink} onClick={()=> navigate('/portfolioPage')}>
        ...
        <div className='links' onClick={()=> navigate('/lightpages')} id='go'>
