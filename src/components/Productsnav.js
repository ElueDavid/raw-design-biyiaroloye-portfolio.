...
import ProductsNav from "../Styles/navproducts.module.css"

export default function Productsnav({page}) {
  ...
  return (
    ...
    <nav className={isWindowScrolled ?'desktop-nav disappear': 'desktop-nav navbar'} ref={navRef}>
        ...
        <div className={ProductsNav.productslinks} onClick={()=> navigate('/productpage')}>
